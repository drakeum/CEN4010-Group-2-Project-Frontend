...
import { Typography, Grid, Button, Stack, Avatar, Paper, IconButton } from "@mui/material";
    ...
    return (
        <>
            <Stack display="flex" sx={{ bm: 2 }}>
                <Typography variant="h2" align="center" color="textPrimary" gutterBottom>Profiles</Typography>
                <Stack direction="row">
                ...
                <Button variant="contained" sx={{my: 1}} onClick={handleClickOpenEditUser}><EditIcon /> Edit Admin Profile</Button>
                    ...
                    >
                        <Grid container spacing={2}>
                            ...
                            <Grid item xs={12} sm container>
                                    ...
                                    <Grid item xs>
                                        <Stack direction="row">
                                            ...
                                            <Typography gutterBottom variant="subtitle1" component="div" sx={{ ml: 1 }}>
                                                ID: {cuser.id}, Name: {cuser.username}
                                            </Typography>
                                        </Stack>
                                ...
                                <Grid item>
                                    <IconButton color="error" aria-label="Remove"><RemoveCircleIcon /></IconButton> { /*onClick={() => handleClickRemoveOpen(property.id)}onClick={() => handleClickEditOpen(property.id)}*/}
                                </Grid>
                            </Grid>
                        </Grid>
                    </Paper>
